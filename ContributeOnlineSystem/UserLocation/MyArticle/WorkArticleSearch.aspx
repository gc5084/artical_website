<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkArticleSearch.aspx.cs" Inherits="UserLocation_MyArticle_WorkArticleSearch" %>
    ...
    <form id="form1" runat="server">
        <div id="main">
            ...
            <div id="form">
                <fieldset>
                    <legend>
                        <img src="../../images/drop-add.gif" style="vertical-align: top;" />我的稿件 </legend>
                    <div id="UserListDiv">
                        <asp:GridView ID="gvArticleList" runat="server" AutoGenerateColumns="false" CssClass="list">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemStyle Width="150px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnCheck" runat="server" CssClass="linkBtn" CommandArgument='<%#Eval("Article_ID")%>'  OnClick="btnCheck_Click" Text="我要评审"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemStyle Width="150px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnDelete" runat="server" CssClass="linkBtn" CommandArgument='<%#Eval("Article_ID")%>' OnClick="btnShowAssess">查看评审意见</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
