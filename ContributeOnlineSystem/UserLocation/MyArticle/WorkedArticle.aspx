<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkedArticle.aspx.cs" Inherits="UserLocation_MyArticle_WorkedArticle" %>
                        ...
                        <asp:GridView ID="gvArticleList" runat="server" AutoGenerateColumns="false" CssClass="list">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemStyle Width="150px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnCheck" runat="server" CssClass="linkBtn" CommandArgument='<%#Eval("Article_ID")%>'  OnClick="btnCheck_Click" Text="详细信息"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemStyle Width="150px" HorizontalAlign="Center" />
