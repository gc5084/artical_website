<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicArticle.aspx.cs" Inherits="UserLocation_MyArticle_PublicArticle" %>
    ...
    <div>
     <div id="main">
            ...
            <div id="form">
                <fieldset>
                    <legend>
                        <img src="../../images/drop-add.gif" style="vertical-align: top;" />待出版稿件 </legend>
                    <div id="UserListDiv">
                        <asp:GridView ID="gvArticleList" runat="server" AutoGenerateColumns="false" CssClass="list">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnShowAssess" runat="server" CssClass="linkBtn"  CommandArgument='<%#Eval("Article_ID")%>' OnClick="btnShowAssess">查看评审信息</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField>
                                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnPublic" runat="server" CssClass="linkBtn" OnClientClick='return confirm("确认出版此文章？")'  CommandArgument='<%#Eval("Article_ID")%>' OnClick="btnPublic">出版文章</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
