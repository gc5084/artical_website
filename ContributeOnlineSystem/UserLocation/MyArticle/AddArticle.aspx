<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddArticle.aspx.cs" Inherits="UserLocation_MyArticle_AddArticle" %>
        ...
        <div id="main">
            <div id="topMenu">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td>
                            <img id="hiddenIco" src="../../images/tool-01.gif" style=" vertical-align:top;cursor: pointer;" onclick="switchBar(this)" title="" />我要投稿
                        </td>
                        <td>
            ...
            <div id="form">
                <fieldset>
                    <legend>
                        <img src="../../images/drop-add.gif" style=" vertical-align:top;"/>我要投稿
                    </legend>
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <div class="selectStyle">
                                    <asp:DropDownList ID="ddlColumn" class="textStyle" runat="server" Width="300px">
                                    </asp:DropDownList>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <div class="selectStyle">
                                    <asp:DropDownList ID="ddlType" class="textStyle" runat="server" Width="200">
                                    </asp:DropDownList>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <span class="btnStyle" style=" margin-right:10px">
                                <asp:Button ID="btnSubmit" runat="server" Text="投稿" CssClass="btn" OnClick="btnSubmit_Click" />
                            </span>
