<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArticleBack.aspx.cs" Inherits="UserLocation_MyArticle_ArticleBack" %>
                        ...
                        <asp:GridView ID="gvArticleList" runat="server" AutoGenerateColumns="false" CssClass="list">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnModify" runat="server" CssClass="linkBtn"  CommandArgument='<%#Eval("Article_ID")%>' OnClick="btnModify">修改稿件</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
