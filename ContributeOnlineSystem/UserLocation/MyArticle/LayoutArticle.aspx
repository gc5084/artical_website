<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LayoutArticle.aspx.cs" Inherits="UserLocation_MyArticle_LayoutArticle" %>
    ...
    <div>
     <div id="main">
            ...
            <div id="form">
                <fieldset>
                    <legend>
                        <img src="../../images/drop-add.gif" style="vertical-align: top;" />待排版稿件 </legend>
                    <div id="UserListDiv">
                        <asp:GridView ID="gvArticleList" runat="server" AutoGenerateColumns="false" CssClass="list">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnPublic" runat="server" CssClass="linkBtn" OnClientClick='return confirm("确认文章已排版？")'  CommandArgument='<%#Eval("Article_ID")%>' OnClick="btnPublic">排版稿件</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
